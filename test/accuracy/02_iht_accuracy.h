...
#ifndef CLOVER_IHT_ACCURACY_H
#define CLOVER_IHT_ACCURACY_H
...
inline void Q_IHT_norm2(
        ...
        uint64_t numberOfEpochs,       // Number of iterations
        uint64_t K,                    // Thresholding parameter
        float mu
) {
    //
    // Get the sizes
...
void test_iht_accuracy (
    ...
    std::cout << std::endl;
    std::cout << "----------------------------------------------------------------------" << std::endl;
    std::cout << "Matrix Phi         : " << Phi.getBitsLength() << "-bit of size: " << m << " x " << n << std::endl;
    std::cout << "Vector y           : " << y.getBitsLength() << "-bit of size: " << m << " x " << n << std::endl;
    std::cout << "Running            : " << numberOfEpochs << " epochs" << std::endl;;
    std::cout << "Sparsity Level (K) : " << K << std::endl;
    std::cout << "Learning Rate (mu) : " << mu << std::endl;
    std::cout << "----------------------------------------------------------------------" << std::endl;
    std::cout << "Epoch      |  Reconstruction Rate" << std::endl;
    std::cout << "----------------------------------------------------------------------" << std::endl;
    //
    // Perform the benchmark
    //
    Q_IHT_norm2(x_32, x, Phi, y, numberOfEpochs, K, mu);
